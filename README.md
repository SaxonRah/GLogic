...
[GeoCPU: A Geometric Computer in HDL](https://github.com/SaxonRah/GLogic/blob/main/GeoCPU_GeometricComputer.md) | [GeoCPUs and Geometirc AI](https://github.com/SaxonRah/GLogic/blob/main/GeoCPU_GeometricAI.md)
